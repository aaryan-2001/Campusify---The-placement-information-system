					...
					<div class="top-nav">
						...
						<ul class="nav1">
							...
							<li class="hvr-sweep-to-bottom">
								<a href="about.php">About Us<i>Campusify</i></a>
							</li>
							<li class="hvr-sweep-to-bottom">
								<a href="mail.php">Mail Us<i>Get in Touch with us Instantly</i></a>
							</li>
							<li class="hvr-sweep-to-bottom">
								<a href="login-user.php">Login/Register<i>Lets Join Us </i></a>
							</li>
		...
		<div class="testimonials">
			<div class="container">
				<div class="testimonial-nfo wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Our Motto</h3>
					<h5>We Just Learn with you and we give you a Platform to Improve Your Future</span>
					</h5>
				</div>
				<div class="testimonial-grids wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<div class="testimonial-grid">
						<p>
							<span>"</span>Our Website is Built with the Endeveour of some great people and We are determined to Express ouselves with
							the Property of True Family Environment. We are Happy to make you inform about the opportunities. Try to Enrich Yourself and Implement to Know More
							than Us.
							<span>"</span>
						</p>
					</div>
		...
		<div class="footer">
			...
			<div class="container">
				...
				<div class="col-md-3 footer-middle wow bounceIn animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h3>Address</h3>
					<div class="address">
						<p>Sagar Institute of Science & Technology, Gandhi Nagar,
				...
				<div class="col-md-3 footer-right  wow fadeInRight animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					<h6 style="color: white">Sagar Institute Of Science And Technology</h6>
					<h4>
						<a href="index.php" style="color: white">Placement Information System</a>
					</h4>
					<p></p>
				</div>
				<div class="clearfix"></div>
		...
		<div class="copyright">
			...
			<div class="container">
				<div class="copyright-left wow fadeInLeft animated" data-wow-delay="0.4s" style="visibility: visible; -webkit-animation-delay: 0.4s;">
					 <p>Copyright &copy; 2022 CAMPUSIFY PROJECT | Developed by Student of Computer Science and Engineering @ SISTec

...
<head>
  ...
  <link rel="shortcut icon" href="favicon.ico" type="image/x-icon">
    ...
    <link rel="stylesheet" type="text/css" href="./themes/pmahomme/css/theme.css?v=5.1.3&nocache=1246239841ltr&server=1">
...
<body>
  ...
  <div class="pma_quick_warp"><div class="drop_list"><button title="Recent tables" class="drop_button btn">Recent</button><ul id="pma_recent_list"><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=campusify&table=usertable">`campusify`.`usertable`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=campusify&table=complaint">`campusify`.`complaint`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=campusify&table=contact">`campusify`.`contact`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=campusify&table=jobapply_tbl">`campusify`.`jobapply_tbl`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=campusify&table=placement_tbl">`campusify`.`placement_tbl`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=campusify&table=tpotable">`campusify`.`tpotable`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hms&table=hostel_manager">`hms`.`hostel_manager`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hms&table=application">`hms`.`application`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hms&table=application_mess">`hms`.`application_mess`</a></li><li class="warp_link"><a href="index.php?route=/table/recent-favorite&db=hms&table=complaint">`hms`.`complaint`</a></li></ul></div><div class="drop_list"><button title="Favorite tables" class="drop_button btn">Favorites</button><ul id="pma_favorite_list"><li class="warp_link">There are no favorite tables.</li></ul></div><div class="clearfloat"></div></div>
...
<div id='pma_navigation_tree_content'>
  ...
  <input type="hidden" name="tab_hash" value="">
    ...
    <input type="hidden" name="token" value="64744b773d2e6c363f3a4e415a3f4153">
  ...
  <div id="pma_console_container">
    <div id="pma_console">
                ...
                <div class="message welcome">
                    ...
                    <span class="hide" id="instructions-1">
                        Press Enter to execute query                    </span>
                            ...
                            targetdb="campusify" targettable="usertable">
            ...
            Queried time
                            ...
                            <span class="query">SELECT * FROM `usertable`</span>
                        </div>

...
<body>
				...
				<div class="top-nav">
					...
					<ul class="nav1">
						...
						<li class="hvr-sweep-to-bottom active">
							<a href="about.php">About Us<i>About Us and our Chief Architects</i></a>
						</li>
	...
	<div class="about-bottom">
		<!-- container -->
		<div class="container">
			<h3 class="wow fadeInRight animated" style="visibility: visible;">A New Generation of INNOVATIONS</h3>

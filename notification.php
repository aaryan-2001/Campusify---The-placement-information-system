...
<?php
	...
	while ($rows=mysqli_fetch_array($run))
	{
		...
		echo "<b>Qualification:</b>".$rows['Qualification']."&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp  <b>Other Requirements:</b>".$rows['OtherReq']."&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp&nbsp <a href=DeleteNotice.php?rn=".$rows['JobID'].">Delete</a>"."<br>";

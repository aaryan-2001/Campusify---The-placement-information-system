...
<body>
    ...
    <div class=" w3l-login-form">
        ...
        <div class=" w3l-form-group">
		 ...
		 <p class=" w3l-register-p">Forgot password?<a href="forgot-password.php" class=" register" > Click Me</a></p>

        <button type="submit" name="login" value="Login">Login</button>
        </form>
        <p class=" w3l-register-p">Login as<a href="login-tpo.php" class="register"> TPO/Admin</a></p>
        <p class=" w3l-register-p">Don't have an account?<a href="signup-user.php" class="register"> Sign up</a></p>
    </div>
    <footer>
